...
export type UpdateSalaryCategoriesFormColumn = z.infer<
  typeof updateSalaryCategoriesSchema
>; // Single API data type
...
export type SalaryCategoriesFormValueColumn = z.infer<
  typeof salaryCategoriesFormdata
>; // Single row with extended id
