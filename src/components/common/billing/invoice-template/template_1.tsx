...
const Invoice_template_1 = ({invoiceData, totalDiscount}: any) => {
  console.log(invoiceData, totalDiscount);
  return (
    <>
      <Card
        style={{
      ...
      >
        <PrintPDFWrapper className="space-y-4" fileName="due-received-report">
          ...
          <div
            style={{ marginBottom: "24px", marginTop: "35px", width: "800px" }}
          >
          ...
          >
            ...
            >
              <div
                style={{ flex: 0, borderRight: "1px solid hsl(var(--border))" }}
              ></div>
              <div
                className="ml-[185px]"
                style={{
            ...
            >
              <div
                style={{ flex: 1, borderRight: "1px solid hsl(var(--border))" }}
              ></div>
              <div
                className="ml-14"
                style={{
            ...
            <div
              style={{ display: "flex", padding: "4px 0", fontWeight: "bold" }}
            >
              <div
                style={{
                  flex: 4,
          ...
          <div style={{ marginTop: "24px" }}>
            ...
            >
              <li>
                Please check and test instruments at the time of delivery. No
                complaint will be accepted after receiving the confirmation.
              </li>
              <li>
                Full payment must be cleared at the time of product delivery.
              </li>
...
export default Invoice_template_1;
