...
const HRM_PendingApprovals = () => {
  const [pagination, setPagination] = React.useState<PaginationState>({
    pageIndex: 0,
    pageSize: 10,
  });
  const { data, isLoading } = useGet_HRM_ApprovalsQuery(
    `per_page=${pagination.pageSize}&page=${pagination.pageIndex + 1}&status=0`
  );
...
export default HRM_PendingApprovals;
