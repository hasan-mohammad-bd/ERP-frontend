  ...
  return (
    <>
      ...
      <Card className="p-3">
        ...
        <h2 className="text-md ml-0 px-2">Employee Service Life</h2> <div className="flex items-center  cursor-pointer"><h2 onClick={() => navigate("/accounts/reports/transaction")}>View All </h2> <ChevronRight size={16} /></div>
        </div>
