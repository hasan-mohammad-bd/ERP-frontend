...
import PurchaseReportFilter from "./components/purchase-report-filter";
import PurchaseReportTable from "./components/purchase-report-table";
...
const dummySalesData = {
  data: [
    {
      date: "2024-10-01",
      business_branch: "Demo_Branch-1",
      invoice: "IN-9834326",
      supplier: "Demo Supplier1",
      purchased_by: "John De",
      product_qty: "demo_qty1",
      invoice_qty: 100,
      total: 2000,
      paid: 750,
      due: 100,
    ...
    {
        date: "2024-10-02",
        business_branch: "Demo_Branch-2",
        invoice: "IN-9834326",
        supplier: "Demo Supplier2",
        purchased_by: "Alex De",
        product_qty: "demo_qty2",
        invoice_qty: 300,
        total: 4000,
        paid: 950,
        due: 200,
...
//   const [selectedDate, setSelectedDate] = useState<Date | undefined>(new Date());
  ...
  return (
    ...
    <div className="flex items-center justify-between">
     ...
     <Separator />
     <PurchaseReportFilter setFilterParams={setFilterParams} selectedDate={selectedDate} setSelectedDate={setSelectedDate} selectedEndDate={selectedEndDate} setSelectedEndDate={setSelectedEndDate}/>
      <Card>
        <PrintPDFWrapper className="space-y-4" fileName="purchase-report">
          <div className="flex-1 space-y-4 my-4">
            <div className="text-center">
              <h2>Akaar IT</h2>
              <h3 className="text-xl">Purchase Report</h3>
            </div>
          </div>
