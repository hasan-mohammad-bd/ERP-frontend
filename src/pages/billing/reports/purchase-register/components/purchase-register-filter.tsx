// // PurchaseRegisterFilter Component
...
// export default function PurchaseRegisterFilter({
//   setFilterParams,
//   selectedDate,
//   setSelectedDate,
//   selectedEndDate,
...
//     })
//     .refine((data) => data.supplier_id || data.start_date || data.end_date, {
...
//     if (selectedSupplier)
//       params.append("contact_id", String(selectedSupplier.id));
