...
const SupplierLedgerReport = () => {
  ...
  const { user } = useAuth(); // Extract user object from useAuth
...
// import { Heading } from "@/components/common/heading";
// import SupplierLedgerFilter from "./components/supplier-ledger-filter";
...
//     />
//     <Card>
//       <PrintPDFWrapper className="space-y-4" fileName="supplier-ledger-report">
//         <div className="flex-1 space-y-4 my-4">
//           <div className="text-center">
//             <h2>Akaar IT</h2>
//             <h3 className="text-xl">Supplier Ledger Report</h3>
...
//           <SupplierLedgerTable tableData={paginatedData} />
//         ) : null}
//       </PrintPDFWrapper>
//       {paginationInfo && (
//         <Paginator
