...
import { CustomerStatementReport } from "@/store/services/billing/api/customer-statement/type";

import { format } from "date-fns";

interface Props {
  reportData: CustomerStatementReport;
  selectedDate?: Date;
  selectedEndDate?: Date;
}

const CustomerStatementReportTable = ({
  reportData,
  selectedDate,
  selectedEndDate,
}: Props) => {
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                ...
                <span>{reportData.customer.address.name}</span>
              </div>
            </div>
...
export default CustomerStatementReportTable;
