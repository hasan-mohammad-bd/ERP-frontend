...
export default function SupplierStatementReportFilter({
  setFilterParams,
  selectedDate,
  setSelectedDate,
  selectedEndDate,
  ...
  const handleApplyFilters = () => {
    ...
    if (selectedSupplier) {
      params.append("supplier_id", String(selectedSupplier.id));
    }
    ...
    const filterParamsObj = {
      ...
      start_date: selectedDate
        ...
        : undefined, // Format the date as a string
    ...
    <Card className="w-full p-5">
      <div className="flex gap-4 flex-wrap">
        <SearchSelect
          ...
          onSelect={(customer) => setSelectedSupplier(customer)}
        />
