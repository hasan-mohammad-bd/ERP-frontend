...
import { AgedPayableDataType } from "@/store/services/billing/api/aged-payable-report/type";

interface Props {
  tableData?: AgedPayableDataType[]; // Update to use SalesDataRow[]
}

const AgedPayableReportTable = ({ tableData }: Props) => {
  return (
    <Card>
      <Table className="">
        <TableHeader>
...
export default AgedPayableReportTable;
