...
const DueReceivedReport = () => {
  ...
  return (
    ...
    <div className="flex items-center justify-between">
     ...
     <Separator />
     <DueReceivedReportFilter setFilterParams={setFilterParams} selectedDate={selectedDate} setSelectedDate={setSelectedDate} selectedEndDate={selectedEndDate} setSelectedEndDate={setSelectedEndDate}/>
      <Card>
...
export default DueReceivedReport;
