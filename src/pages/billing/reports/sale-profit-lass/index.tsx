...
import { useGetSaleWiseProfitLossQuery } from "@/store/services/billing/api/reports/sale-profit-lass";

const SaleProfitLass = () => {
  ...
  const { data, isLoading } = useGetSaleWiseProfitLossQuery(
    `${filterParams}`,
          ...
          >
            <div className="flex-1 space-y-4 my-4">
              <div className="text-center">
                <h2>Akaar IT</h2>
                <h3 className="text-xl">Sale Wise Profit Lass Report</h3>
              </div>
            </div>
