...
import { purchaseReceiveColumns } from "./components/columns";
      ...
      <div className="flex flex-col">
        <div className="flex-1 space-y-4">
          <div className="flex items-center justify-between">
            ...
            />
            <Button
              onClick={() => navigate("/billing/purchase-receive/add")}
              size={"sm"}
            >
              <Plus className="mr-2 h-4 w-4" /> Add Purchase Receive
            </Button>
          </div>
          <Separator />
          {data && (
            <div>
              <DataTable
                columns={purchaseReceiveColumns}
                data={data}
